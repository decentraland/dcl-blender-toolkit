...
class OBJECT_OT_quick_export_gltf(bpy.types.Operator):
    ...
    def _realize_from_collection(self, context, emp, coll, offset_inv, parent_matrix, scene_col, realized):
    ...
    def execute(self, context):
        ...
        try:
            ...
            if self.atlas_optimize_enabled:
                ...
                if realized_objects:
                    export_objects = [o for o in export_objects if o not in instance_empties] + realized_objects
